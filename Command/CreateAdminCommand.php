...
class CreateAdminCommand extends ContainerAwareCommand
{
  ...
  protected static $defaultName = 'sylius:admin:create';
  ...
  {
    $output->writeln('Command will create the administrator.') ;
    $this->setupAdministratorUser($input, $output, "en_US") ;
    return 0;
  }
  ...
  protected function setupAdministratorUser(InputInterface $input, OutputInterface $output, string $localeCode): void
  {
      ...
      $outputStyle->writeln('Administrator account <info>successfully registered.</info>') ;
      $outputStyle->newLine() ;
  }
